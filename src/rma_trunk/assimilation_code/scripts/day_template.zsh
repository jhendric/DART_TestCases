...
#
# DART $Id: day_template.zsh 10982 2017-02-01 23:43:10Z thoar@ucar.edu $
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/scripts/day_template.zsh $
# $Revision: 10982 $
