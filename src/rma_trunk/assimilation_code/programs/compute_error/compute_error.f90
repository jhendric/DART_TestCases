...
!
! $Id: compute_error.f90 11545 2017-04-27 18:00:20Z hendric@ucar.edu $
...
character(len=256), parameter :: source = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/programs/compute_error/compute_error.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11545 $"
character(len=128), parameter :: revdate  = "$Date: 2017-04-27 12:00:20 -0600 (Thu, 27 Apr 2017) $"
