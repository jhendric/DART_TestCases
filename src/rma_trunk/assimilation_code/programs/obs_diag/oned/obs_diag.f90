...
!
! $Id: obs_diag.f90 11925 2017-08-30 22:43:39Z thoar@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/programs/obs_diag/oned/obs_diag.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11925 $"
character(len=128), parameter :: revdate  = "$Date: 2017-08-30 16:43:39 -0600 (Wed, 30 Aug 2017) $"
...
! $Id: obs_diag.f90 11925 2017-08-30 22:43:39Z thoar@ucar.edu $
! $Revision: 11925 $
! $Date: 2017-08-30 16:43:39 -0600 (Wed, 30 Aug 2017) $
