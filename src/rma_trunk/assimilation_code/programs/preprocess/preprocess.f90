...
!
! $Id: preprocess.f90 11251 2017-03-08 23:04:37Z hendric@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/programs/preprocess/preprocess.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11251 $"
character(len=128), parameter :: revdate  = "$Date: 2017-03-08 16:04:37 -0700 (Wed, 08 Mar 2017) $"
...
! $Id: preprocess.f90 11251 2017-03-08 23:04:37Z hendric@ucar.edu $
! $Revision: 11251 $
! $Date: 2017-03-08 16:04:37 -0700 (Wed, 08 Mar 2017) $
