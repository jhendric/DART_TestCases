...
!
! $Id: sys_sim101a.f90 11289 2017-03-10 21:56:06Z hendric@ucar.edu $

program sys_sim101a

! LOOKS AT DEALING WITH ADDITIONAL UNCERTAINTY FROM FINITE SAMPLE
! GENERATING THE SAMPLE MEAN AND SD USED TO COMPUTE RATIO. USE
! ANALYTIC FORMULA FOR THIS OR GET IT FROM SOMEWHERE ELSE?
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/programs/system_simulation/sys_sim101a.f90 $"
...
read(*, *) sd_ratio
write(*, *) 'Input group size, NORMALLY 1 for this problem'
read(*, *) n
