...
!
! $Id: sys_sim104b.f90 11289 2017-03-10 21:56:06Z hendric@ucar.edu $

program sys_sim104b

! MAKING SURE THAT RATIO IS ALL THAT MATTERS
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/programs/system_simulation/sys_sim104b.f90 $"
...
! Need an ensemble sized sample of the recursion value
   do j = 1, n
      rnum(j) = random_gaussian(r, dble(0.1), sd_ratio * 0.1)
   end do
