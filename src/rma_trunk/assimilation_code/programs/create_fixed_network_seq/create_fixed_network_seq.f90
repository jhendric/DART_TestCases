...
!
! $Id: create_fixed_network_seq.f90 11667 2017-05-26 15:47:11Z jla@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/programs/create_fixed_network_seq/create_fixed_network_seq.f90 $"
