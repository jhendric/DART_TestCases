...
!
! $Id: ensemble_manager_mod.f90 11760 2017-06-27 15:30:36Z thoar@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/modules/utilities/ensemble_manager_mod.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11760 $"
character(len=128), parameter :: revdate  = "$Date: 2017-06-27 09:30:36 -0600 (Tue, 27 Jun 2017) $"
...
! $Id: ensemble_manager_mod.f90 11760 2017-06-27 15:30:36Z thoar@ucar.edu $
! $Revision: 11760 $
! $Date: 2017-06-27 09:30:36 -0600 (Tue, 27 Jun 2017) $
