...
!
! $Id: filter_mod.dopplerfold.f90 11920 2017-08-29 22:20:46Z hendric@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/modules/assimilation/filter_mod.dopplerfold.f90 $"
...
if (observations_updateable .and. prior_post == PRIOR_DIAG) then
  call update_observations_radar(obs_fwd_op_ens_handle, ens_size, seq, keys, prior_post, &
