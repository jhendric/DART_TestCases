...
!
! $Id: assim_tools_mod.f90 11920 2017-08-29 22:20:46Z hendric@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/modules/assimilation/assim_tools_mod.f90 $"
