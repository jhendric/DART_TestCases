...
!
! $Id: sampling_error_correction_mod.f90 11620 2017-05-10 22:03:57Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/modules/assimilation/sampling_error_correction_mod.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11620 $"
character(len=128), parameter :: revdate  = "$Date: 2017-05-10 16:03:57 -0600 (Wed, 10 May 2017) $"
...
! $Id: sampling_error_correction_mod.f90 11620 2017-05-10 22:03:57Z nancy@ucar.edu $
! $Revision: 11620 $
! $Date: 2017-05-10 16:03:57 -0600 (Wed, 10 May 2017) $
