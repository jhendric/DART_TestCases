...
!
! $Id: quality_control_mod.f90 11759 2017-06-27 15:28:56Z thoar@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/assimilation_code/modules/assimilation/quality_control_mod.f90 $"
