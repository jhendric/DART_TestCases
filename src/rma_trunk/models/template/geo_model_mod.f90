...
!
! $Id: geo_model_mod.f90 11612 2017-05-08 22:18:42Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/template/geo_model_mod.f90 $"
