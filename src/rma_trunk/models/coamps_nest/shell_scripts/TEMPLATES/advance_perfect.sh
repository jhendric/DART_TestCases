...
#
# DART $Id: advance_perfect.sh 6256 2013-06-12 16:19:10Z thoar $
#
###############################################################################
#
# AUTHOR:   P. A. Reinecke
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/coamps_nest/shell_scripts/TEMPLATES/advance_perfect.sh $
# $Revision: 6256 $
