...
# These scripts don't need to be customized and so they have a static location
set NL_STRIP=${COAMPS_DART_DIR}/shell_scripts/strip_namelist.pl
set TAU_UPDATE=${COAMPS_DART_DIR}/shell_scripts/modify_times.pl
...
set digits = 5
set ensdir = `printf "%0${digits}d" $element`
...
set dtg = `awk -F"'" '/cdtg/{print $2}' namelist`
...
set ic_file = `printf assim_model_state_ic.%04d ${element}`
...
# program dump the information in a dart.kstart file
${TAU_UPDATE} dart.kstart ${COAMPS_ENS}/namelist
...
set ud_file = `printf assim_model_state_ud.%04d ${element}`
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/coamps_nest/shell_scripts/COAMPS_RESTART_SCRIPTS/advance_model.csh $
# $Revision: 6256 $
