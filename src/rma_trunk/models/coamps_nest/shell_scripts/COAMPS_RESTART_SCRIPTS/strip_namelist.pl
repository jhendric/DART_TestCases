...
#
# DART $Id: strip_namelist.pl 6256 2013-06-12 16:19:10Z thoar $
#
########################################################################
#
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/coamps_nest/shell_scripts/COAMPS_RESTART_SCRIPTS/strip_namelist.pl $
# $Revision: 6256 $
