...
#
# DART $Id: install_externals.sh 6256 2013-06-12 16:19:10Z thoar $
#
########################################################################
#
# AUTHOR:   T. R. Whitcomb
...
EXTERNALS_PATH=models/coamps_nest/externals
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/coamps_nest/shell_scripts/install_externals.sh $
# $Revision: 6256 $
