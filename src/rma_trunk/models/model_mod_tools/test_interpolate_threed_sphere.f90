...
!
! $Id: test_interpolate_threed_sphere.f90 11752 2017-06-22 22:22:13Z hendric@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/model_mod_tools/test_interpolate_threed_sphere.f90 $"
