...
!
! DART $Id: test_dipole_interp.f90 10977 2017-02-01 18:15:42Z thoar@ucar.edu $
...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/POP/test_dipole_interp.f90 $
! $Id: test_dipole_interp.f90 10977 2017-02-01 18:15:42Z thoar@ucar.edu $
! $Revision: 10977 $
