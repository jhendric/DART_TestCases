...
#
# DART $Id: stitch_prior.sh 10982 2017-02-01 23:43:10Z thoar@ucar.edu $
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/POP/shell_scripts/stitch_prior.sh $
# $Revision: 10982 $
