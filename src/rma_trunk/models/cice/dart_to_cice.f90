...
!
! $Id: dart_to_cice.f90 11702 2017-06-08 03:01:46Z thoar@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/cice/dart_to_cice.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11702 $"
character(len=128), parameter :: revdate  = "$Date: 2017-06-07 21:01:46 -0600 (Wed, 07 Jun 2017) $"
...
! $Id: dart_to_cice.f90 11702 2017-06-08 03:01:46Z thoar@ucar.edu $
! $Revision: 11702 $
! $Date: 2017-06-07 21:01:46 -0600 (Wed, 07 Jun 2017) $
