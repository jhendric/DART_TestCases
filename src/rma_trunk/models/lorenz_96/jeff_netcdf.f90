...
!
! $Id: jeff_netcdf.f90 11545 2017-04-27 18:00:20Z hendric@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/lorenz_96/jeff_netcdf.f90 $"
