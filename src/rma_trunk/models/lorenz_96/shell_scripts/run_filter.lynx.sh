...
#
# DART $Id: run_filter.lynx.sh 10982 2017-02-01 23:43:10Z thoar@ucar.edu $
#
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/lorenz_96/shell_scripts/run_filter.lynx.sh $
# $Revision: 10982 $
