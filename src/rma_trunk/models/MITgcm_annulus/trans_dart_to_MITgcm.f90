...
!
! $Id: trans_dart_to_MITgcm.f90 10977 2017-02-01 18:15:42Z thoar@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/MITgcm_annulus/trans_dart_to_MITgcm.f90 $"
