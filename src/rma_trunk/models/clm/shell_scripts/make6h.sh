...
#
# $Id: make6h.sh 10982 2017-02-01 23:43:10Z thoar@ucar.edu $
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/clm/shell_scripts/make6h.sh $
# $Revision: 10982 $
