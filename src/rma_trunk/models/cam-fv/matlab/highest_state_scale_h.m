...
%
% DART $Id: highest_state_scale_h.m 10990 2017-02-02 23:39:18Z thoar@ucar.edu $

default_nu_top = 0.00001;
args = inputParser;

addRequired(args,'fname',@ischar);
addRequired(args,'div24del2flag',@isnumeric);
...
% $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/cam-fv/matlab/highest_state_scale_h.m $
% $Revision: 10990 $
