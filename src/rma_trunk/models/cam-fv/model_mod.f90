...
! $Id: model_mod.f90 11793 2017-07-07 16:58:41Z raeder@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/cam-fv/model_mod.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11793 $"
character(len=128), parameter :: revdate  = "$Date: 2017-07-07 10:58:41 -0600 (Fri, 07 Jul 2017) $"
!-----------------------------------------------------------------------
