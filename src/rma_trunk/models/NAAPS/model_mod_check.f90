...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/NAAPS/model_mod_check.f90 $"
...
character(len=129) :: naaps_input_file  ! set with get_model_analysis_filename() if needed
...
!
! call get_model_analysis_filename( naaps_input_file )
!
! write(*,*)
! write(*,*)'Reading restart files from  '//trim(naaps_input_file)
!
! call analysis_file_to_statevector (naaps_input_file, statevector, en, model_time )
! 
! write(*,*)
