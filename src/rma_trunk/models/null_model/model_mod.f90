...
!
! $Id: model_mod.f90 11868 2017-08-02 22:55:43Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/null_model/model_mod.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11868 $"
character(len=128), parameter :: revdate  = "$Date: 2017-08-02 16:55:43 -0600 (Wed, 02 Aug 2017) $"
...
! $Id: model_mod.f90 11868 2017-08-02 22:55:43Z nancy@ucar.edu $
! $Revision: 11868 $
! $Date: 2017-08-02 16:55:43 -0600 (Wed, 02 Aug 2017) $
