...
#
# DART $Id: spinup_model.pl 11545 2017-04-27 18:00:20Z hendric@ucar.edu $
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/lorenz_96_2scale/shell_scripts/spinup_model.pl $
# $Revision: 11545 $
