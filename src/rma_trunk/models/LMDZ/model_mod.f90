...
character(len=128), parameter :: &
   source   = "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/LMDZ/model_mod.f90 $", &
   revision = "$Revision: 11545 $", &
   revdate  = "$Date: 2017-04-27 12:00:20 -0600 (Thu, 27 Apr 2017) $"
...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/LMDZ/model_mod.f90 $
! $Id: model_mod.f90 11545 2017-04-27 18:00:20Z hendric@ucar.edu $
! $Revision: 11545 $
