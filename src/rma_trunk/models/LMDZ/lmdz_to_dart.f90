...
!
! $Id: lmdz_to_dart.f90 10977 2017-02-01 18:15:42Z thoar@ucar.edu $
...
character(len=128), parameter :: &
   source   = "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/LMDZ/lmdz_to_dart.f90 $", &
   revision = "$Revision: 10977 $", &
   revdate  = "$Date: 2017-02-01 11:15:42 -0700 (Wed, 01 Feb 2017) $"
...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/LMDZ/lmdz_to_dart.f90 $
! $Id: lmdz_to_dart.f90 10977 2017-02-01 18:15:42Z thoar@ucar.edu $
! $Revision: 10977 $
