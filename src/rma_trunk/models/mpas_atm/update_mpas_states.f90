...
!
! $Id: update_mpas_states.f90 11794 2017-07-07 17:20:17Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/mpas_atm/update_mpas_states.f90 $"
