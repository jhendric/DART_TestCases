...
!
! DART $Id: ModEarth.f90 6256 2013-06-12 16:19:10Z thoar $
...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/gitm/GITM2/src/ModEarth.f90 $
! $Id: ModEarth.f90 6256 2013-06-12 16:19:10Z thoar $
! $Revision: 6256 $
