...
!
! DART $Id: ModTime.f90 6256 2013-06-12 16:19:10Z thoar $
...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/gitm/GITM2/src/ModTime.f90 $
! $Id: ModTime.f90 6256 2013-06-12 16:19:10Z thoar $
! $Revision: 6256 $
