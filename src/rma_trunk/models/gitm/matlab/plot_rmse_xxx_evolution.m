...
% Extension of the observation-space diagnostics routines - creates .ps files
%
...
%
% DART $Id: plot_rmse_xxx_evolution.m 10998 2017-02-03 22:23:13Z thoar@ucar.edu $
...
%          clf; orient landscape; wysiwyg
      ...
      for iregion = 1:plotdat.nregions
         ...
         alex_data{alex}=myplot(plotdat);
         alex=alex+1;
      end

      % create a postscript file if desired
...
function alex_data=myplot(plotdat)
...
alex_data=[t rmse other nobs_poss nobs_used];
...
% $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/gitm/matlab/plot_rmse_xxx_evolution.m $
% $Revision: 10998 $
