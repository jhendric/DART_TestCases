...
obs_vposs_r = f.variables['SAT_RHO_guess'][:,0,3,0]
obs_vused_r = f.variables['SAT_RHO_guess'][:,1,3,0]
obs_vrmse_r = f.variables['SAT_RHO_guess'][:,6,3,0]
obs_vbias_r = f.variables['SAT_RHO_guess'][:,7,3,0]
obs_vspread_r = f.variables['SAT_RHO_guess'][:,8,3,0]
obs_vtotspread_r = f.variables['SAT_RHO_guess'][:,9,3,0]
obs_vbadqc_r = f.variables['SAT_RHO_guess'][:,10,3,0]
obs_vtruth_r = f.variables['SAT_RHO_guess'][:,11,3,0]
obs_vensm_r = f.variables['SAT_RHO_guess'][:,12,3,0]

obs_vposs_o = f.variables['SAT_RHO_analy'][:,0,3,0]
obs_vused_o = f.variables['SAT_RHO_analy'][:,1,3,0]
obs_vrmse_o = f.variables['SAT_RHO_analy'][:,6,3,0]
obs_vbias_o = f.variables['SAT_RHO_analy'][:,7,3,0]
obs_vspread_o = f.variables['SAT_RHO_analy'][:,8,3,0]
obs_vtotspread_o = f.variables['SAT_RHO_analy'][:,9,3,0]
obs_vbadqc_o = f.variables['SAT_RHO_analy'][:,10,3,0]
obs_vtruth_o = f.variables['SAT_RHO_analy'][:,11,3,0]
obs_vensm_o = f.variables['SAT_RHO_analy'][:,12,3,0]
f.close()
...
# DART $Id: plot_champ.py 11545 2017-04-27 18:00:20Z hendric@ucar.edu $
# from Alexey Morozov

# <next few lines under version control, do not edit>
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/gitm/python/plot_champ.py $
# $Revision: 11545 $
