...
# DART $Id: read_gps_txt.py 11001 2017-02-03 23:08:55Z thoar@ucar.edu $
# from Alexey Morozov

# <next few lines under version control, do not edit>
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/gitm/python/read_gps_txt.py $
# $Revision: 11001 $
