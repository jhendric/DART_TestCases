...
# DART $Id: plot_tec.py 11545 2017-04-27 18:00:20Z hendric@ucar.edu $
# from Alexey Morozov

# <next few lines under version control, do not edit>
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/gitm/python/plot_tec.py $
# $Revision: 11545 $
