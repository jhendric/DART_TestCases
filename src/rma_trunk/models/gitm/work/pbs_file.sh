#!/bin/bash
#
# DART $Id: pbs_file.sh 10982 2017-02-01 23:43:10Z thoar@ucar.edu $
#
#PBS -S /bin/bash
#PBS -N dart_test_tec
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/gitm/work/pbs_file.sh $
# $Revision: 10982 $
