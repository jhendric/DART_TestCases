...
character(len=128) :: version = '$Revision: 4943 $'
character(len=128) :: tagname = '$Id: orig_atmos_tracer_utilities.f90 4943 2011-06-02 21:49:34Z thoar $'
...
real, dimension(size(T,1),size(T,2)) :: Htemp, dz, washout,scav_factor, sum_wdep,dz
