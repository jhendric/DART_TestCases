...
!
! $Id: model_mod.f90 11920 2017-08-29 22:20:46Z hendric@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/bgrid_solo/model_mod.f90 $"
...
character(len=32 ), parameter :: version = "$Revision: 11920 $"
character(len=128), parameter :: tag = "$Id: model_mod.f90 11920 2017-08-29 22:20:46Z hendric@ucar.edu $"
