...
%
% DART $Id: prior_post_err.m 10990 2017-02-02 23:39:18Z thoar@ucar.edu $
...
post_mean = mean(post_full_vec(time_ind, :, :), 2);
...
% $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/models/bgrid_solo/matlab/prior_post_err.m $
% $Revision: 10990 $
