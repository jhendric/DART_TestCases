...
!
! $Id: obs_def_ocean_mod.f90 11611 2017-05-05 23:10:55Z thoar@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/forward_operators/obs_def_ocean_mod.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11611 $"
character(len=128), parameter :: revdate  = "$Date: 2017-05-05 17:10:55 -0600 (Fri, 05 May 2017) $"
