...
C DART $Id: grabbufr.f 11860 2017-08-02 16:05:57Z nancy@ucar.edu $
...
C $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/NCEP/prep_bufr/convert_bufr/grabbufr.f $
C $Id: grabbufr.f 11860 2017-08-02 16:05:57Z nancy@ucar.edu $
C $Revision: 11860 $
C $Date: 2017-08-02 10:05:57 -0600 (Wed, 02 Aug 2017) $
