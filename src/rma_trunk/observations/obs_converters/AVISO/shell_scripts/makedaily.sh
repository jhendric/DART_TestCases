...
#
# DART $Id: makedaily.sh 11279 2017-03-09 22:39:55Z thoar@ucar.edu $
#
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/AVISO/shell_scripts/makedaily.sh $
# $Revision: 11279 $
