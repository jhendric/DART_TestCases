...
!
! DART $Id: convert_cosmic_ionosphere.f90 11931 2017-09-08 17:07:55Z thoar@ucar.edu $
...
character(len=*), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/gps/convert_cosmic_ionosphere.f90 $"
character(len=*), parameter :: revision = "$Revision: 11931 $"
character(len=*), parameter :: revdate  = "$Date: 2017-09-08 11:07:55 -0600 (Fri, 08 Sep 2017) $"
...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/gps/convert_cosmic_ionosphere.f90 $
! $Id: convert_cosmic_ionosphere.f90 11931 2017-09-08 17:07:55Z thoar@ucar.edu $
! $Revision: 11931 $
! $Date: 2017-09-08 11:07:55 -0600 (Fri, 08 Sep 2017) $
