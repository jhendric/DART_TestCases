...
%
% DART $Id: gloc1_14.m 10990 2017-02-02 23:39:18Z thoar@ucar.edu $
...
load loc_june1_14.dat;
lat_pts = loc_june1_14(:, 1);
lon_pts = loc_june1_14(:, 2);

% subplot('position', [0.1,0.2,0.7,0.7]);
 plotm(lat_pts,lon_pts,'k*',  'markersize', 4.0);
...
% $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/gps/matlab/gloc1_14.m $
% $Revision: 10990 $
