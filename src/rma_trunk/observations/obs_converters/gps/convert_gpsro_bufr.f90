...
!
! $Id: convert_gpsro_bufr.f90 11855 2017-08-01 22:49:23Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/gps/convert_gpsro_bufr.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11855 $"
character(len=128), parameter :: revdate  = "$Date: 2017-08-01 16:49:23 -0600 (Tue, 01 Aug 2017) $"
...
! $Id: convert_gpsro_bufr.f90 11855 2017-08-01 22:49:23Z nancy@ucar.edu $
! $Revision: 11855 $
! $Date: 2017-08-01 16:49:23 -0600 (Tue, 01 Aug 2017) $
