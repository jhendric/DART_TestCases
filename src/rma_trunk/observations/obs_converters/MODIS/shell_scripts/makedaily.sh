...
#
# DART $Id: makedaily.sh 10982 2017-02-01 23:43:10Z thoar@ucar.edu $

# Split a long file into "daily" files which start at 00:00Z the
# previous day and end at 23:59Z on the day that matches the day in the
...
# content to have 'daily' files with observations from the 24 hour
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/MODIS/shell_scripts/makedaily.sh $
# $Revision: 10982 $
