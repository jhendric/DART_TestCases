...
!
! $Id: COSMOS_development.f90 11243 2017-03-08 21:35:09Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/COSMOS/COSMOS_development.f90 $"
