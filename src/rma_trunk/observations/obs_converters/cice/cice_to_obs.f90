...
!
! DART $Id: cice_to_obs.f90 11700 2017-06-07 01:36:03Z thoar@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/cice/cice_to_obs.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 11700 $"
character(len=128), parameter :: revdate  = "$Date: 2017-06-06 19:36:03 -0600 (Tue, 06 Jun 2017) $"
...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/cice/cice_to_obs.f90 $
! $Id: cice_to_obs.f90 11700 2017-06-07 01:36:03Z thoar@ucar.edu $
! $Revision: 11700 $
