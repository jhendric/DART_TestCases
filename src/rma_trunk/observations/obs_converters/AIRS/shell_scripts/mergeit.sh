...
#
# DART $Id: mergeit.sh 10982 2017-02-01 23:43:10Z thoar@ucar.edu $
#
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/observations/obs_converters/AIRS/shell_scripts/mergeit.sh $
# $Revision: 10982 $
