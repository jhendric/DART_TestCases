 ...
 *
 * DART $Id: ctest_nc.c 10998 2017-02-03 22:23:13Z thoar@ucar.edu $
 */
 ...
 * $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/developer_tests/mpi_utilities/tests/ctest_nc.c $
 * $Revision: 10998 $
