...
!
! $Id: test_read_write_restarts.f90 11289 2017-03-10 21:56:06Z hendric@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/developer_tests/io/test_read_write_restarts.f90 $"
