...
!
! $Id: test_state_structure.f90 11686 2017-05-31 20:42:33Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/developer_tests/io/test_state_structure.f90 $"
