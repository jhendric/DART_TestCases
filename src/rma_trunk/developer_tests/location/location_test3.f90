...
!
! $Id: location_test3.f90 11612 2017-05-08 22:18:42Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/developer_tests/location/location_test3.f90 $"
