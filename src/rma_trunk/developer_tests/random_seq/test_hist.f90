...
!
! $Id: test_hist.f90 11289 2017-03-10 21:56:06Z hendric@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/developer_tests/random_seq/test_hist.f90 $"
