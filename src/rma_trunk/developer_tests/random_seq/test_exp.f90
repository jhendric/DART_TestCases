...
!
! $Id: test_exp.f90 11849 2017-07-31 17:21:33Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/rma_trunk/developer_tests/random_seq/test_exp.f90 $"
